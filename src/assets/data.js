...
export const WHYCHOOSEDATA = [
    {
        icon: "fa-leaf",
        title: "منابع پایدار",
        description: "ما مستقیماً با کشاورزان همکاری می‌کنیم تا از رویه‌های اخلاقی و کیفیت برتر دانه‌ها اطمینان حاصل کنیم.",
    },
    {
        icon: "fa-award",
        title: "برشته‌کاری تخصصی",
        description: "برشته‌کاران چیره‌دست ما، طعم بی‌نظیر هر خاستگاه قهوه را بیرون می‌آورند.",
    },
    {
        icon: "fa-truck",
        title: "تحویل تازه",
        description: "قهوه ظرف ۲۴ ساعت برشته و ارسال می‌شود تا حداکثر تازگی را تضمین کند.",
    },
]
...
export const STORYDATA = [
    {
        title: "هنر دم‌آوری قهوه پور-اور",
        date: "۴ تیر ۱۴۰۴",
...
export const FILTEROPTIONS = {
    beanType: ["عربیکا", "روبوستا", "ترکیبی"],
    origin: [
        "اتیوپی",
        "کلمبیا",
        "برزیل",
    ...
    roastLevel: ["روشن", "متوسط روشن", "متوسط", "متوسط تیره", "تیره"],
    coffeeType: ["تک خاستگاه", "ترکیبی", "اسپرسو", "فیلتر"],
    flavor: [
        "شکلاتی",
        "میوه‌ای",
        "گل",
    ...
    packaging: ["۲۵۰ گرم", "۵۰۰ گرم", "۱ کیلوگرم"],
    brand: ["قهوه بهشت", "اسپشیالتی", "برشته کاران", "کافی روستر"],
}
...
export const PRODUCTS = [
    ...
    {
        id: 16,
        name: "پاپوا گینه نو سیگری",
        origin: "پاپوا گینه نو",
        roastLevel: "متوسط",
